...
# near_ten(19) -> True
def near_ten(n):
  return (n+2) % 10 == 0 or (n-2) % 10 == 0 or (n+1) % 10 == 0 or (n-1) % 10 == 0 or n % 10 == 0
...
def fila_tijolos(n_peq, n_gra, meta):
  return meta <= n_peq + n_gra * 5 and meta % 5 <= n_peq
